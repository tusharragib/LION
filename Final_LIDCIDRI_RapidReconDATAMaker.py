...
Loads 3D CT sinograms (.npy), runs OS-ASD-POCS rapid iterative reconstructions (only 5 iterations) to 
...
def run_reconstruction_pipeline(
    ...
    for fp in tqdm(sinogram_files, desc="Reconstructing volumes"):
        try:
            ...
            out_filename = fp.stem.replace("_sinogram", "_recon5") + ".npy"
...
if __name__ == "__main__":
    ...
    OUTPUT_DIR = Path("/store/cia-lion/smrsi2/TIGRE-LIDC-IDRI_data_recon5")

    run_reconstruction_pipeline(INPUT_DIR, OUTPUT_DIR, num_iter=5)